...
capacity_configs_manual512 = [
    'configs_capacity/config_qdmr_vanilla_512.json',
    'configs_capacity/config_qdmr_length_512.json',
    'configs_capacity/config_qdmr_domain_512.json',
    'configs_capacity/config_program_vanilla_512.json',
    'configs_capacity/config_program_length_512.json',
    'configs_capacity/config_program_domain_512.json',
    'configs_capacity/config_minimized_vanilla_512.json',
    'configs_capacity/config_minimized_length_512.json',
    'configs_capacity/config_minimized_domain_512.json'
]
...
for configuration in capacity_configs_manual1024:
