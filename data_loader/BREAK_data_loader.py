...
class BREAKDataLoader(BaseDataLoader):
    ...
    def __init__(self, data_dir, batch_size, gold_type, domain_split, length_split, shuffle=True, validation_split=0.0,
    ...
    def split_validation(self):
        ...
        """
        return BREAKDataLoaderValid(self.data_dir, self.batch_size, self.gold_type, self.domain_split,
                                    self.length_split, self.shuffle, self.validation_split,
...
class BREAKDataLoaderValid(BaseDataLoader):
    ...
    def __init__(self, data_dir, batch_size, gold_type, domain_split, length_split, shuffle=True, validation_split=0.0,
        ...
        self.length_split = length_split
        self.dataset = custom_datasets.BREAKLogical(self.data_dir, gold_type, domain_split, length_split,
                                                    train=training, valid=True, debug=debug)
        self.dataset_split = self.dataset.get_dataset_split()
        self.drop_last = True
